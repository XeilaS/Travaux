...
function init () {
    ...
    transition.begin(facebook1, [["transform", "scale(0)", "scale(1)", "2s", "linear"],]);
    transition.begin(logo, [["transform", "scale(0)", "scale(1)", "2s", "linear"],]);

    transition.begin(photos, [["transform", "scale(0)", "scale(1)", "2s", "linear"],]);

    transition.begin(club, [["transform", "scale(0)", "scale(1)", "2s", "linear"],]);

    transition.begin(saisons, [["transform", "scale(0)", "scale(1)", "2s", "linear"],]);
...
/*
* Initialise le lancement de la fonction majHorloge toutes les secondes afin de metttre à jour le compte à rebours
 * @param { Date } date Date de l'épreuve à transmettre à la fonction majHorloge
* */
...
/**
 *
 * @param {Date} uneDate - La date de l'épreuve
 * @returns {{heure: number, jour: number, difEnMs: number, seconde: number, minute: number}}
 */
