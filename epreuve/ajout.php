<?php
// Objectif : Affichage du formulaire de saisie d'une nouvelle épreuve
// Fonction appelante :  Menu Ajouter - Epreuve organiséer par le club (menu.php)
// Résultat  envoyé : Formulaire HTML
