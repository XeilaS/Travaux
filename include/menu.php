...
if ($reportage === 1) {
    $menu4s .= <<<EOD
         <a class="dropdown-item" href="{$chemin}reportage/consultation.php">Les reportages photos</a>
         <a class="dropdown-item" href="{$chemin}reportagevideo/consultation.php">Les reportages vidéos</a>
